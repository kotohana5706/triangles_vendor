...
ifeq ($(CM_BUILDTYPE), RELEASE)
    ifndef TARGET_VENDOR_RELEASE_BUILD_ID
        CM_VERSION := $(PRODUCT_NAME)-$(ANDROID_CODENAME)-$(CM_BUILD)-$(TRIANGLES_BUILDTYPE)-$(TRIANGLES_MAJORVERSION).$(TRIANGLES_MINORVERSION)-$(shell date -u +%Y%m%d)
    else
...
ANDROID_CODENAME = 4.4.4
TRIANGLES_BUILDTYPE = BETA1
TRIANGLES_DEFAULT_VERSION = BETA1
TRIANGLES_MAJORVERSION = v2
TRIANGLES_MINORVERSION = 5
...
PRODUCT_PROPERTY_OVERRIDES += \
  ro.cm.version=$(TRIANGLES_MODVERSION) \
  ro.cm.releasetype=$(CM_BUILDTYPE) \
  ro.modversion=$(TRIANGLES_MODVERSION) \
